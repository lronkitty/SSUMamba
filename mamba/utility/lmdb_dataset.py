...
def savedataset():
    dataset = LMDBDataset('/home/ironkitty/nas_data/datasets/houston/houston512_46.db')
    import scipy.io as io
    for i in range(len(dataset)):
        x = dataset[i]
        x = x.transpose(1, 2, 0)
        io.savemat("/home/ironkitty/nas_data/datasets/houston/houston512_46_mac/houston_ori_"+str(i)+".mat", {'DataCube':x})
...
if __name__ == '__main__':
    ...
    savedataset()
    # dataset = LMDBDataset('/home/ironkitty/nas_data/datasets/houston/houston64_stride_24_46.db')
